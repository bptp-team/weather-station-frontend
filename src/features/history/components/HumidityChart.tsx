    ...
    <HistoryChartShell title="Umidade do ar" description="Intensidade histórica em %">
      <ResponsiveContainer width="100%" height={240}>
        <AreaChart data={data}>
          ...
          <Tooltip labelFormatter={(value) => formatChartDate(Number(value))} formatter={(value) => formatChartValue(Number(value), "%")} />
          <Area type="monotone" dataKey="air_humidity" name="Umidade" stroke="#17735f" fill="#a6ccc0" fillOpacity={0.55} />
        </AreaChart>
      </ResponsiveContainer>
    </HistoryChartShell>
  );
