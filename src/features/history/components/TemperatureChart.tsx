    ...
    <HistoryChartShell title="Temperatura do ar" description="Variação histórica em °C">
      <ResponsiveContainer width="100%" height={240}>
        <LineChart data={data}>
          ...
          <Tooltip labelFormatter={(value) => formatChartDate(Number(value))} formatter={(value) => formatChartValue(Number(value), "°C")} />
          <Line type="monotone" dataKey="air_temperature" name="Temperatura" stroke="#c65a43" dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </HistoryChartShell>
  );
